...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://blog.dosick.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/sobersjh",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1634817314",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://www.streetfighter.com/6/buckler/zh-hans/profile/3352944001",
		},
		{
			name: "BageVM",
			icon: "mdi:server",
			url: "https://www.bagevm.com/clientarea.php?action=productdetails&id=16050&language=chinese",
		},
		{
			name: "Discord",
			icon: "fa7-brands:discord",
			url: "https://discord.com/users/1117787453424672850",
		},
	],
};
